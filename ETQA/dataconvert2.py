...
for q_type in question_types:
    if q_type in original_data and original_data[q_type] is not None:
        conversations = []  # Initialize the conversations list for this question type
        for key, details in original_data[q_type].items():
            ...
            # Append each question and answer pair to the conversations list
...
output_file_path = 'converteddata2.json'
